...
def send():
    if request.method == 'POST':
        ...
        for x in range(0, len(event_id)):
            ...
            entry_check = tabroomSoup.select('div > div[class="threequarters"]')
            print(entry_check)
        ...
        return render_template('LDreturn.html', len=len(tournament_storage), tournament_storage=tournament_storage,
